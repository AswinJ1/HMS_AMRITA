...
export default function SecurityProfilePage() {
  ...
  useEffect(() => {
    if (!session?.user || (session.user.role as string) !== "STAFF") {
          ...
          <Card className="md:col-span-1">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                  <AvatarSelector
                  currentAvatar={profile.staff.avatarUrl}
                  gender={profile.staff.gender}
                  onSave={handleAvatarSave}
                  fallbackInitials={getInitials(profile.staff.name)}
                  />
                ...
                <div className="w-full mt-4 space-y-3">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>{profile.staff.department}</span>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{profile.staff.name}</p>
                  </div>
                  
                  <div>
                    <label className="text-sm font-medium text-gray-500">Department</label>
                    <p className="text-gray-900 mt-1">{profile.staff.department}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{formatDate(profile.staff.createdAt)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
