...
const StaffApprovalsPage = () => {
  ...
  const fetchApprovals = async () => {
    ...
    try {
      console.log("🔄 Fetching staff approvals...")
      
      // Try staff-specific endpoint first
      const response = await fetch("/api/staff/approvals")
      
      if (!response.ok) {
        // Fallback to general approvals endpoint
        const fallbackResponse = await fetch("/api/approvals")
        ...
        console.log("✅ Fetched staff approvals:", data)
        setApprovals(data)
      }
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Review and approve stayback requests as staff member</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow mb-8">
          ...
          {pendingApprovals.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm">New requests will appear here for your review.</p>
            </div>
          ) : (
