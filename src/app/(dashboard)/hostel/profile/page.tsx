...
export default function SecurityProfilePage() {
  ...
  useEffect(() => {
    if (!session?.user || (session.user.role as string) !== "HOSTEL") {
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button
            onClick={() => router.push("/hostel/edit_profile")}
          ...
          <Card className="md:col-span-1">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                  <AvatarSelector
                  currentAvatar={profile.hostel.avatarUrl}
                  gender={profile.hostel.gender}
                  onSave={handleAvatarSave}
                  fallbackInitials={getInitials(profile.hostel.name)}
                  />
                ...
                <div className="w-full mt-4 space-y-3">
                  {/* <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>{profile.hostel.department}</span>
                  </div> */}
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{profile.hostel.name}</p>
                  </div>
                  
                  {/* <div>
                    <label className="text-sm font-medium text-gray-500">Department</label>
                    <p className="text-gray-900 mt-1">{profile.hostel.department}</p>
                  </div> */}
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{formatDate(profile.hostel.createdAt)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
