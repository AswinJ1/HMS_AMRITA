...
export default function TeamleadProfilePage() {
  ...
  useEffect(() => {
    if (!session?.user || (session.user.role as string) !== "TEAM_LEAD") {
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button
            onClick={() => router.push("/team-lead/edit_profile")}
          ...
          <Card className="md:col-span-1">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                  <AvatarSelector
                  currentAvatar={profile.teamLead.avatarUrl}
                  gender={profile.teamLead.gender}
                  onSave={handleAvatarSave}
                  fallbackInitials={getInitials(profile.teamLead.name)}
                  />
                
                <h2 className="text-2xl font-bold text-gray-900 mb-1">
                  {profile.teamLead.name}
                </h2>
                ...
                <div className="w-full mt-4 space-y-3">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>{profile.teamLead.clubName}</span>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{profile.teamLead.name}</p>
                  </div>
                  
                  <div>
                    <label className="text-sm font-medium text-gray-500">Club Name</label>
                    <p className="text-gray-900 mt-1">{profile.teamLead.clubName}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mt-1">{formatDate(profile.teamLead.createdAt)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            {/* <Card>
              ...
              <CardContent className="space-y-2">
                <Button 
                  ...
                  onClick={() => router.push("/staff/edit_profile")}
                >
